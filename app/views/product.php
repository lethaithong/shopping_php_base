               ...
               <div class="d-flex align-items-center justify-content-between mb-4 float-right">
                  ...
                  <div class="dropdown ml-4">
                     ...
                     <div class="dropdown-menu dropdown-menu-right" aria-labelledby="triggerId">
                        <a class="dropdown-item <?php if(isset($_GET['price_asc'])) {echo 'active';} ?>" href="<?php echo BASE_URL ?>sanpham/filter_product?price_asc">Giá tăng dần</a>
                        <a class="dropdown-item <?php if(isset($_GET['price_desc'])) {echo 'active';} ?>" href="<?php echo BASE_URL ?>sanpham/filter_product?price_desc">Giá giảm dần</a>
               ...
               <nav aria-label="Page navigation">
                  <ul class="pagination justify-content-center mb-3">
                     ...
                     <?php
                        ...
                        $next_page = "";
                        $prev_page = "";
                        $total = ceil(count($count_product)/6);
                     ...
                     <?php if($page <= $total && $page != 1) { ?>
                        <li class="page-item">
                           <a class="page-link" href="<?php echo BASE_URL ?>sanpham<?php if(isset($_GET['price_asc'])) {echo '/filter_product?price_asc&';} else if(isset($_GET['price_desc'])) {echo '/filter_product?price_desc&';} else{echo '?';}?>trang=<?php echo $prev_page ?>" aria-label="Previous">
                     ...
                     <?php
                      for($i = 1 ; $i<=$total; $i++  ) { ?>
                     <li class="page-item <?php if(($page == $i)) {echo 'active';} ?>"><a class="page-link" href="<?php echo BASE_URL ?>sanpham<?php if(isset($_GET['price_asc'])) {echo '/filter_product?price_asc&';} else if(isset($_GET['price_desc'])) {echo '/filter_product?price_desc&';} else{echo '?';}?>trang=<?php echo $i ?>"><?php echo $i ?></a></li>
                     <?php } ?>

                     <?php if($page < $total) { ?>
                        <li class="page-item">
                           <a class="page-link"  href="<?php echo BASE_URL ?>sanpham<?php if(isset($_GET['price_asc'])) {echo '/filter_product?price_asc&';} else if(isset($_GET['price_desc'])) {echo '/filter_product?price_desc&';} else{echo '?';}?>trang=<?php echo $next_page ?>">
