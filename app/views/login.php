                     ...
                     <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                        <div class="brand-logo">
                           ...
                           <?php 
                            ...
                            ?>
                        <form autocomplete="on" action="<?php echo BASE_URL ?>login/login_user"
                           method="POST" class="pt-3">
                           <div class="form-group">
                              <input class="form-control form-control-lg" id="exampleInputEmail1"
                                 placeholder="Nhập email..." required type="email" name="email" maxlength="30">
                           </div>
                           <div class="form-group">
                              <input class="form-control form-control-lg" id="password-field"
                                 placeholder="Nhập mật khẩu..." required type="password" name="password" maxlength="30">
